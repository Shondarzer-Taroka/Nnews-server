...
// export const createEpaper = async (req: Request, res: Response) => {
//   try {
...
// // Update an e-paper
// export const updateEpaper = async (req: Request, res: Response) => {
//   try {
//     const { id } = req.params;
...
// // Delete an e-paper
// export const deleteEpaper = async (req: Request, res: Response) => {
//   try {
//     const { id } = req.params;
//     const userId = req.user.id;
...
// export const getEpapersByDateRange = async (req: Request, res: Response) => {
//   try {
...
// // Get latest e-papers
// export const getLatestEpapers = async (req: Request, res: Response) => {
//   try {
