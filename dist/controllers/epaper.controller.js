...
exports.getLatestEpapers = exports.getEpapersByDateRange = exports.getEpaperById = exports.getAllEpapers = exports.deleteEpaper = exports.updateEpaper = exports.createEpaper = exports.addManyData = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const verifyAuthenticatedUser = (req) => {
...
exports.createEpaper = createEpaper;
// Update an e-paper
...
exports.updateEpaper = updateEpaper;
// Delete an e-paper
...
exports.deleteEpaper = deleteEpaper;
...
exports.getAllEpapers = getAllEpapers;
...
exports.getEpaperById = getEpaperById;
// Get e-papers by date range
const getEpapersByDateRange = async (req, res) => {
    try {
        ...
        const response = epapers.map(epaper => ({
            ...epaper,
            date: epaper.date,
            createdAt: epaper.createdAt,
            updatedAt: epaper.updatedAt,
...
exports.getEpapersByDateRange = getEpapersByDateRange;
// Get latest e-papers
const getLatestEpapers = async (req, res) => {
    try {
...
exports.getLatestEpapers = getLatestEpapers;
