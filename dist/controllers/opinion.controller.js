...
exports.deleteOpinion = exports.updateOpinion = exports.getRelatedOpinions = exports.getOpinions = exports.getOpinionById = exports.createOpinion = void 0;
...
const createOpinion = async (req, res) => {
    try {
        const { title, content, category, subCategory, imageSource = "Unknown", imageTitle = "Untitled", keywords = [], subKeywords = [], imageUrl, authorId } = req.body;
